...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set([line1, line2], { transformOrigin: "50% 50%", rotate: 0, y: 0 });
  ...
  const animateIcon = useCallback((opening: boolean) => {
    ...
    if (opening) {
      gsap.to(l1, { y: 3, rotate: 45, duration: 0.5, ease: "power4.out", overwrite: "auto" });
      gsap.to(l2, { y: -3, rotate: -45, duration: 0.5, ease: "power4.out", overwrite: "auto" });
    } else {
      gsap.to(l1, { y: 0, rotate: 0, duration: 0.35, ease: "power3.inOut", overwrite: "auto" });
      gsap.to(l2, { y: 0, rotate: 0, duration: 0.35, ease: "power3.inOut", overwrite: "auto" });
    }
  }, []);
